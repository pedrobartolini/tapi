...
> = {
  method: TMethod;
  endpoint: string;
  response: ResponseSchema.ResponseConfig<TResponse, TMapped, TMapArg>;
};

export type RouteDefinitions = {
  [key: string]: RequestConfig<any, any, any, any, any, any, any, any, any> | RouteDefinitions;
};
...
type ExtractPath<T> = T extends RequestConfig<any, infer P, any, any, any, any, any, any, any> ? P : undefined;
type ExtractBody<T> = T extends RequestConfig<any, any, infer B, any, any, any, any, any, any> ? B : undefined;
type ExtractFormData<T> = T extends RequestConfig<any, any, any, infer F, any, any, any, any, any> ? F : undefined;
type ExtractQuery<T> = T extends RequestConfig<any, any, any, any, infer Q, any, any, any, any> ? Q : undefined;
type ExtractHeaders<T> = T extends RequestConfig<any, any, any, any, any, infer H, any, any, any> ? H : undefined;
type ExtractMapArg<T> = T extends RequestConfig<any, any, any, any, any, any, any, any, infer M> ? M : undefined;

export type RequesterParams<T extends RequestConfig<any, any, any, any, any, any, any, any, any>> = InferPathParam<ExtractPath<T>> &
...
export type InferMapperParams<T extends RequestConfig<any, any, any, any, any, any, any, any, any>> =
  ExtractMapArg<T> extends undefined ? { map?: never } : { map: ExtractMapArg<T> };

export type CallSignature<T extends RequestConfig<any, any, any, any, any, any, any, any, any>> = InferPathParam<ExtractPath<T>> &
  InferBodyParam<ExtractBody<T>> &
  InferFormDataParam<ExtractFormData<T>> &
  InferQueryParam<ExtractQuery<T>> &
  InferHeaderParam<ExtractHeaders<T>> &
...
export type RequesterFunction<TConfig extends RequestConfig<any, any, any, any, any, any, any, any, any>, TError = string> = ((
